 ...
 *
 *   node --experimental-strip-types proofs/runners/history-proof.ts
 *
 * Connects the canonical proof account (config in proofs/private/config.json:
...
const privateDir = path.join(root, "proofs", "private");
