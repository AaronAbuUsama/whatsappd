...
- A listener that throws stays subscribed and its failure is rethrown
  asynchronously. It was previously unsubscribed silently and permanently, so
  it never received `closed` and its stream simply went quiet.
