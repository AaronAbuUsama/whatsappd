...
| `DATA-08` | durability | Persist all currently normalized message kinds in the Current Mirror. | not-applicable: n/a | implemented | Current whatsappd implements this capability. | Transparent message state | Data/projection owner to be assigned by #68 |
