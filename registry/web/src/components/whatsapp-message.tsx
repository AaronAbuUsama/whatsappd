...
import { WhatsAppOperationStatus } from "@/components/whatsapp-operation-status";
import { useWhatsAppAssetSources } from "@/lib/whatsappd/whatsapp-assets";
import type {
  ApplicationMessage,
...
function MediaContent({
  ...
  const assets = useWhatsAppAssetSources();
  ...
  const url = assets.media(content.media!);
    ...
    <Message align={message.fromMe ? "end" : "start"}>
      <MessageContent>
        ...
        <MessageFooter>
          ...
          <WhatsAppOperationStatus message={message} browser={browser} />
        </MessageFooter>
      </MessageContent>
    </Message>
  );
